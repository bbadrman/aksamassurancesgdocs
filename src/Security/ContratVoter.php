 ...
 */
final class ContratVoter extends Voter
{
    ...
    private function mapLegacyAttribute(string $attribute): string
    {
        return match ($attribute) {
            // Legacy mappings
            'CONTRAT_VIEW' => Permission::CONTRATS_VIEW_LIST,
            'CONTRAT_CREATE' => Permission::CONTRATS_CREATE,
            'CONTRAT_EDIT' => Permission::CONTRATS_EDIT,
            'CONTRAT_DELETE' => Permission::CONTRATS_DELETE,
